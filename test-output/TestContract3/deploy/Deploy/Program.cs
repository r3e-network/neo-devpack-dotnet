...
namespace TestContract3.Deploy;
...
class Program
{
    ...
    {
        Console.WriteLine("=== Deploying TestContract3 ===");
        
        // Deploy the contract - simple one-liner!
        var deploymentResult = await toolkit.Deploy("../../src/TestContract3/TestContract3.csproj");
    ...
    static async Task UpdateExistingContract(DeploymentToolkit toolkit)
    {
        ...
        var updateResult = await toolkit.Update(
            ...
            "../../src/TestContract3/TestContract3.csproj" // Updated project
        );
