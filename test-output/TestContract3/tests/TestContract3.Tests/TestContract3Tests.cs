...
namespace TestContract3.Tests
{
    public class TestContract3Tests : TestBase<TestContract3>
    {
        private readonly TestEngine _engine;
        private readonly UInt160 _defaultOwner;

        public TestContract3Tests()
        {
        ...
        {
            var contract = _engine.Deploy<TestContract3>(new Neo.SmartContract.Testing.Storage.NonPersistentStorageProvider());
    ...
    public abstract class TestContract3 : SmartContract.Testing.SmartContract
    {
