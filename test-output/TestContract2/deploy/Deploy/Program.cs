...
namespace TestContract2.Deploy;
...
class Program
{
    ...
    {
        Console.WriteLine("=== Deploying TestContract2 ===");
        
        // Deploy the contract - simple one-liner!
        var deploymentResult = await toolkit.Deploy("../../src/TestContract2/TestContract2.csproj");
    ...
    static async Task UpdateExistingContract(DeploymentToolkit toolkit)
    {
        ...
        var updateResult = await toolkit.Update(
            ...
            "../../src/TestContract2/TestContract2.csproj" // Updated project
        );
