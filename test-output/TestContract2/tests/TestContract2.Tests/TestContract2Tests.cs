...
namespace TestContract2.Tests
{
    public class TestContract2Tests : TestBase<TestContract2>
    {
        private readonly TestEngine _engine;
        private readonly UInt160 _defaultOwner;

        public TestContract2Tests()
        {
        ...
        {
            var contract = _engine.Deploy<TestContract2>(new Neo.SmartContract.Testing.Storage.NonPersistentStorageProvider());
    ...
    public abstract class TestContract2 : SmartContract.Testing.SmartContract
    {
